...
public class Enemy
{
    ...
    public static final String[] ENEMY_NAMES = { "Zombie", "Skeleton", "Warrior", "Goblin", "Werewolf",
                                                 "Vampire" ,"Gremlin","Chupacabra","Banshee","Lockness Monster",
                                                    "Yeti","Mummy","Orc","Kraken", "Golem","Godzilla","Medusa",
                                                    "Basilisk","Frankentein","Chimera"};
