...
public class Enemy
{
    ...
    public static final String[] ENEMY_NAMES = { "Zombie", "Skeleton", "Warrior", "Goblin", "Werewolf", "Vampire", "Witch", "Orc", "Imp", "Giant",
                                                "Demon", "Spider", "Dementor", "Dragon", "Halfling", "Clown", "White Walker","Bat", "Undead", "Oni"};
