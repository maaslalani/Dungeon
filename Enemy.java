...
public class Enemy {
     ...
     */
    public static final String[] ENEMY_NAMES = {"Zombie", "Skeleton", "Warrior", "Goblin", "Werewolf", "Vampire", "Beast Patient", "DarkNut", "Moldorm",
            "Wallmaster", "Wizrobe", "Beast Claw Hunter", "Hemwick Grave Woman", "Merciless Watcher", "Bone Ash Hunter", "Brick Troll", "Brainsucker",
            "Snatcher", "Labyrinth Sage", "Chime Maiden", "Executioner", "Mad One", "Silver Lady", "Dusk Walker", "Spark Golem", "Murlocs", "Reapers",
            "Zinyak", "Spriggans", "Voltrix", "Stray Demon", "Basilisk", "Murkman", "Serpent-man", "Darkwraith"};
