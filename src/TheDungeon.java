...
public class TheDungeon
{
    ...
    public static void main(String[] argument)
    {
        ...
        {
            // Main enemy
            Enemy villain = new Zombie();
            List<Class<? extends Enemy>> list = Arrays.asList(Goblin.class, Skeleton.class, Vampire.class, Warrior.class,Zombie.class, Werewolf.class);
            try {
